...
//	  delay(1000);
//  	  System.out.println("			*** RadarViewSwingImpl updating ... " + value + " nn=" + nn);
...
//		double  dp = curPref.distanceTo(MY_LOCATION);
//	  	System.out.println(" +++ " + name +" loc=" + pref.getLocation() + " DISTANCE=" + dp );
 }
