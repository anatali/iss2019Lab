	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		return { //this:ActionBasciFsm
				...
				state("waitForEvents") { //this:State
					action { //it:State
						stateTimer = TimerActor("timer_waitForEvents", scope, context!!, "local_tout_sonardatahandler_waitForEvents", 60000.toLong())
					}
					 transition(edgeName="t13",targetState="endOfJob",cond=whenTimeout("local_tout_sonardatahandler_waitForEvents"))   
