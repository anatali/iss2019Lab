		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="sAdd",cond=whenTimeout("local_tout_dynamo_s0"))   
				}	 
				state("sAdd") { //this:State
					action { //it:State
						resources.ledManager.addNewLed()
						stateTimer = TimerActor("timer_sAdd", scope, context!!, "local_tout_dynamo_sAdd", 4000.toLong())
					}
					 transition(edgeName="t01",targetState="sRemove",cond=whenTimeout("local_tout_dynamo_sAdd"))   
				}	 
