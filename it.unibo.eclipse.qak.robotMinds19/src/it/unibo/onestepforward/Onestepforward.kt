...
package it.unibo.onestepforward
...
class Onestepforward ( name: String, scope: CoroutineScope ) : ActorBasicFsm( name, scope){
				...
				state("doMoveForward") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_doMoveForward", 
							scope, context!!, "local_tout_onestepforward_doMoveForward", StepTime )
					}
					 transition(edgeName="t010",targetState="endDoMoveForward",cond=whenTimeout("local_tout_onestepforward_doMoveForward"))   
