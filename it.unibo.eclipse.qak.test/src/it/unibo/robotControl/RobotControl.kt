		...
		return { //this:ActionBasciFsm
				...
				state("moveAhead") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_moveAhead", 
							scope, context!!, "local_tout_robotcontrol_moveAhead", 1500.toLong() )
					}
					 transition(edgeName="t111",targetState="moveBack",cond=whenTimeout("local_tout_robotcontrol_moveAhead"))   
				...
				state("moveBack") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_moveBack", 
							scope, context!!, "local_tout_robotcontrol_moveBack", 1500.toLong() )
					}
					 transition(edgeName="t114",targetState="moveAhead",cond=whenTimeout("local_tout_robotcontrol_moveBack"))   
